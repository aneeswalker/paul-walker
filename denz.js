...
try {
        ...
        mess = {
			...
			only: {
				...
				ownerB: 'ᴏɴʟʏ ғᴏʀ ⁩ī.ᴀᴍ/ꪶ͢ᴘᴀᴜʟᴡᴀʟᴋᴇʀꫂ⁩🥂',
...
☯ 𝙳𝙰𝚈 : ${week} ${weton}
☯ 𝙳𝙰𝚃𝙴 : ${calender}`
sendButLocation(from, `${menu}`, "ꪶ͢ᴘᴀᴜʟᴡᴀʟᴋᴇʀꫂ⁩", {jpegThumbnail:gambar,name:""}, [
{buttonId:`allmenu`,buttonText:{displayText:'😱SHOW MENU'},type:1},
{buttonId:`owner`,buttonText:{displayText:'😎OWNER'},type:1},
{buttonId:`script`,buttonText:{displayText:'📃SCRIPT'},type:1}
...
༆ᴀᴅɪᴛʜʜᴀʀɪ / ᴀᴍᴇᴇɴ / ī.ᴀᴍ/ꪶ͢ᴘᴀᴜʟᴡᴀʟᴋᴇʀꫂ⁩༄
ʟᴏᴠᴇ ʏᴏᴜ ᴀʟʟ!`
...
const btnbc = {
    ...
    footerText: '*_ʙʀᴏᴀᴅᴄᴀsᴛ ʙʏ ꪶ͢ᴘᴀᴜʟᴡᴀʟᴋᴇʀꫂ⁩_*',
    buttons: buttonss,
    headerType: 1
}
...
┃𒈒 *ɴᴀᴍᴇ ʙᴏᴛ* : ꪶ͢𝑆𝐾𝑌𝐿𝐼𝑁𝐸ꫂ⁩
┃𒈒 *ɴᴀᴍᴇ ᴏᴡɴᴇʀ* : ꪶ͢ᴘᴀᴜʟᴡᴀʟᴋᴇʀꫂ⁩
┃𒈒 *ᴄʀᴇᴀᴛᴏʀ* : @917356378949
┃𒈒 *sᴘᴇᴇᴅ* : 00065
┗━━𒆜
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ᴇʀʀᴏʀ-ᴀʟᴇʀᴛ* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "ꪶ͢ᴘᴀᴜʟᴡᴀʟᴋᴇʀꫂ⁩",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://wa.me/917356378949?text=Hi Bro"}}})
	}
    }
    }
    }
